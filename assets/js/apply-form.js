// ==========================================================================
// CredBaba — Loan Application form logic
// ==========================================================================
...
(function () {
  ...
  function getSelectedLoanTypes() {
    return Array.from(form.querySelectorAll('input[name="loanType"]:checked')).map((el) => el.value);
  }
  ...
  function validateField(name) {
    switch (name) {
      ...
      case 'loanType':
        return setFieldState('f-loanType', V.validateLoanInterest(getSelectedLoanTypes()));
      case 'amount':
  ...
  function validateAll() {
    const fields = ['firstName', 'lastName', 'fatherName', 'dob', 'gender', 'mobile', 'altMobile', 'pan', 'aadhaar', 'loanType', 'amount'];
    let allValid = true;
  ...
  form.querySelectorAll('input[name="loanType"]').forEach((el) => {
    el.addEventListener('change', () => validateField('loanType'));
  });
  ...
  form.addEventListener('submit', async function (e) {
    ...
    const payload = {
      ...
      loanTypes: getSelectedLoanTypes().join(', '),
